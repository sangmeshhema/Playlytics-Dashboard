...
app.get("/", (req, res) => {
  res.send("Playlytics API Running 🚀");
});
...
app.post("/game", auth, async (req, res) => {
  ...
  try {
    ...
    res.json("Game added successfully ✅");
...
app.get("/steam/:steamid", async (req, res) => {
  ...
  process.env.STEAM_API_KEY;
    ...
    res.status(500).send("Steam API Error ❌");
